      ...
      <div className=" bg-main py-5 flex  gap-x-4  ">
        ...
        {data && (
          <div
            ...
            className="w-44  hover:w-44 h-60 bg-blend-saturation  grayscale backdrop-blur  bg-white/30 flex justify-center group items-center transition-all duration-250 ease-linear cursor-pointer"
          >
